...
public class ChatMessage implements Serializable {
	...
	//
	public enum MsgType{NO_ACT,CREATION,CREATION_FAILURE,CREATION_SUCCESS,CONFIRM,CONFIRM_FAILURE,CHANGE,LOGIN,LOGIN_FAILURE,ADD,FRIEND_EXIST,ADD_FAILURE,FRIEND_LIST,END,LOGOUT,USER_MSG,SERVER_MSG};
